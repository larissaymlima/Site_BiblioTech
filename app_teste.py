...
def exigir_administrador():
    ...
    if not eh_administrador_logado():
        return resposta(False, "Acesso negado. Ação restrita ao cargo Administrador.", "danger", "admin_dashboard")
    return None
...
# -----------------------------------------------------------------------------
# 📚 CATÁLOGO & DETALHES — usa catalogo.html -- OK
# -----------------------------------------------------------------------------
...
def catalogo():
    ...
    try:
        ...
        # Temporariamente retornando JSON para testar no Thunder Client
        return jsonify({
...
def obter_detalhes_livro(id):
    ...
    try:
        ...
        # Retorno em JSON para testes no Thunder Client
        return jsonify({
            'livro': livro,
